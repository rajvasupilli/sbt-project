...
#RUN echo "deb https://dl.bintray.com/sbt/debian /" |  tee -a sudo /etc/apt/sources.list.d/sbt.list

#RUN sudo curl -sL "https://keyserver.ubuntu.com/pks/lookup?op=get&search=0x2EE0EA64E40A89B84B2DF73499E82A75642AC823" | apt-key add
